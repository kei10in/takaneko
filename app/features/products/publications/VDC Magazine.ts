...
export const VDCMagazine035: Publication = {
  ...
  links: [
    ...
    {
      text: "オフショット 3",
      url: "https://x.com/VDC_tokyo/status/1927998354941968477",
    },
    {
      text: "オフショット 4",
...
export const VDCMagazine030: Publication = {
  ...
  links: [
    {
      text: "VDC ストア",
      url: "https://vdc.stores.jp/items/667128b7e126f8003391c953",
    },
  ],
};
...
export const VDCMagazine029: Publication = {
  ...
  featuredMembers: ["橋本桃呼", "東山恵里沙", "日向端ひな", "松本ももな", "籾山ひめり"],
  officialTwitter: "https://x.com/takanenofficial/status/1738077052279140490",
  links: [
    {
      text: "VDC ストア",
      url: "https://vdc.stores.jp/items/65efe57e9dfb09002eb055f7",
    },
  ],
};
