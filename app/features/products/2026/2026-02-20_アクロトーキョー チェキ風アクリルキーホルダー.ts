...
export const アクロトーキョー_チェキ風アクリルキーホルダー: RandomGoods = {
  id: "アクロトーキョー チェキ風アクリルキーホルダー",
  slug: "アクロトーキョー チェキ風アクリルキーホルダー",
  name: "アクロトーキョー コラボグッズ チェキ風アクリルキーホルダー",
  year: 2026,
  series: "アクロトーキョー スペシャル コラボレーション グッズ",
  category: "アクリルキーホルダー",
  tradeText: TradeTextType.Description,
  url: "/takaneko/goods/2026/2026-02-20_アクロトーキョー チェキ風アクリルキーホルダー.webp",
  width: 1500,
  height: 1500,
  variants: [
    { id: 1, name: "橋本桃呼", description: "Gamchu" },
    { id: 2, name: "橋本桃呼", description: "TRAVAS TOKYO" },
    { id: 3, name: "橋本桃呼", description: "ililil" },
    { id: 4, name: "橋本桃呼", description: "REFLEM" },
    { id: 5, name: "城月菜央", description: "Grrr the Lipper" },
    { id: 6, name: "城月菜央", description: "AdaNous" },
    { id: 7, name: "城月菜央", description: "TRAVAS TOKYO" },
    { id: 8, name: "城月菜央", description: "REFLEM" },
  ],
  withFrame: true,
  positions: [
