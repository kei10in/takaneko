...
export const meta: EventMetaDescriptor = {
  summary: "OKINAWA COLLECTION 2026",
  category: "FASHION",
  liveType: undefined,
  date: "2026-06-20",
  open: "13:00",
...
export const content = /* md */ `
  ...
  - [あいらいふ幼稚園 (動画に涼海すうが出演 8:27 〜) - iLIFE! X](https://x.com/iLiFE_official/status/2068668010739745266)
  - [出演報告 - 公式 X](https://x.com/takanenofficial/status/2068307986435744188)
