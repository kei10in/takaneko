...
export const この世界は嘘でできている白衣装 = {
  kind: "mv",
  name: "「この世界は嘘でできている」白衣装",
  slug: "この世界は嘘でできている白衣装",
} satisfies MvCostume;

export const この世界は嘘でできている黒衣装 = {
  kind: "mv",
  name: "「この世界は嘘でできている」黒衣装",
  slug: "この世界は嘘でできている黒衣装",
} satisfies MvCostume;

export const この世界は嘘でできている私服衣装 = {
  kind: "mv",
  name: "「この世界は嘘でできている」私服衣装",
  slug: "この世界は嘘でできている私服衣装",
} satisfies MvCostume;

export const ライフクエストお仕事衣装 = {
  kind: "mv",
  name: "「ライフクエスト」お仕事衣装",
  slug: "ライフクエストお仕事衣装",
} satisfies MvCostume;
...
export const 東京サニーパーティーパジャマ衣装 = {
  kind: "mv",
  name: "「東京サニーパーティー」パジャマ衣装",
  slug: "東京サニーパーティーパジャマ衣装",
} satisfies MvCostume;

export const 小悪魔だってかまわない衣装 = {
  kind: "mv",
  name: "「小悪魔だってかまわない」衣装",
  slug: "小悪魔だってかまわない衣装",
} satisfies MvCostume;
