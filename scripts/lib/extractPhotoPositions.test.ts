...
describe("extractPhotoPositions", () => {
  it("extracts every photo position from real sample 1", async () => {
    ...
    expect(result.value.positions).toEqual([
      ...
      { id: 14, x: 452, y: 172, width: 96, height: 137 },
