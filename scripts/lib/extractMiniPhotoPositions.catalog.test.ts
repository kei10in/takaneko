...
describe("extractMiniPhotoPositions for catalog images", () => {
  ...
  it("extracts ピンク衣装", async () => {
    ...
    if (result.err) return;
    expect(result.value.positions).toEqual([
      { id: 1, x: 58, y: 249, width: 175, height: 276 },
      { id: 2, x: 304, y: 249, width: 175, height: 276 },
      { id: 3, x: 550, y: 249, width: 175, height: 276 },
      { id: 4, x: 796, y: 249, width: 175, height: 276 },
      { id: 5, x: 1042, y: 249, width: 175, height: 276 },
      { id: 6, x: 1288, y: 249, width: 175, height: 276 },
      { id: 7, x: 58, y: 565, width: 175, height: 276 },
      { id: 8, x: 304, y: 565, width: 175, height: 276 },
      { id: 9, x: 550, y: 565, width: 175, height: 276 },
      { id: 10, x: 796, y: 565, width: 175, height: 276 },
      { id: 11, x: 1042, y: 565, width: 175, height: 276 },
      { id: 12, x: 1288, y: 565, width: 175, height: 276 },
      { id: 13, x: 58, y: 881, width: 175, height: 276 },
      { id: 14, x: 304, y: 881, width: 175, height: 276 },
      { id: 15, x: 550, y: 881, width: 175, height: 276 },
      { id: 16, x: 796, y: 881, width: 175, height: 276 },
      { id: 17, x: 1042, y: 881, width: 175, height: 276 },
      { id: 18, x: 1288, y: 881, width: 175, height: 276 },
      { id: 19, x: 58, y: 1197, width: 175, height: 276 },
      { id: 20, x: 304, y: 1197, width: 175, height: 276 },
      { id: 21, x: 550, y: 1197, width: 175, height: 276 },
      { id: 22, x: 796, y: 1197, width: 175, height: 276 },
      { id: 23, x: 1042, y: 1197, width: 175, height: 276 },
      { id: 24, x: 1288, y: 1197, width: 175, height: 276 },
      { id: 25, x: 58, y: 1513, width: 175, height: 276 },
      { id: 26, x: 304, y: 1513, width: 175, height: 276 },
      { id: 27, x: 550, y: 1513, width: 175, height: 276 },
      { id: 28, x: 796, y: 1513, width: 175, height: 276 },
      { id: 29, x: 1042, y: 1513, width: 175, height: 276 },
      { id: 30, x: 1288, y: 1513, width: 175, height: 276 },
    ]);
  });
  ...
  it("extracts アイドル衣装", async () => {
    ...
    if (result.err) return;
    expect(result.value.positions).toEqual([
      { id: 1, x: 22, y: 182, width: 181, height: 245 },
      { id: 2, x: 229, y: 182, width: 181, height: 245 },
      { id: 3, x: 436, y: 182, width: 181, height: 245 },
      { id: 4, x: 643, y: 182, width: 181, height: 245 },
      { id: 5, x: 850, y: 182, width: 181, height: 245 },
      { id: 6, x: 1057, y: 182, width: 181, height: 245 },
      { id: 7, x: 22, y: 447, width: 181, height: 245 },
      { id: 8, x: 229, y: 447, width: 181, height: 245 },
      { id: 9, x: 436, y: 447, width: 181, height: 245 },
      { id: 10, x: 643, y: 447, width: 181, height: 245 },
      { id: 11, x: 850, y: 447, width: 181, height: 245 },
      { id: 12, x: 1057, y: 447, width: 181, height: 245 },
      { id: 13, x: 22, y: 712, width: 181, height: 245 },
      { id: 14, x: 229, y: 712, width: 181, height: 245 },
      { id: 15, x: 436, y: 712, width: 181, height: 245 },
      { id: 16, x: 643, y: 712, width: 181, height: 245 },
      { id: 17, x: 850, y: 712, width: 181, height: 245 },
      { id: 18, x: 1057, y: 712, width: 181, height: 245 },
      { id: 19, x: 22, y: 977, width: 181, height: 245 },
      { id: 20, x: 229, y: 977, width: 181, height: 245 },
      { id: 21, x: 436, y: 977, width: 181, height: 245 },
      { id: 22, x: 643, y: 977, width: 181, height: 245 },
      { id: 23, x: 850, y: 977, width: 181, height: 245 },
      { id: 24, x: 1057, y: 977, width: 181, height: 245 },
      { id: 25, x: 22, y: 1242, width: 181, height: 245 },
      { id: 26, x: 229, y: 1242, width: 181, height: 245 },
      { id: 27, x: 436, y: 1242, width: 181, height: 245 },
      { id: 28, x: 643, y: 1242, width: 181, height: 245 },
      { id: 29, x: 850, y: 1242, width: 181, height: 245 },
      { id: 30, x: 1057, y: 1242, width: 181, height: 245 },
    ]);
  });
