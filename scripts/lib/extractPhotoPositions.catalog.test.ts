...
describe("extractPhotoPositions for catalog images", () => {
  ...
  it("extracts 2024年振袖", async () => {
    ...
    expect(result.value.positions).toEqual([
      ...
      { id: 4, x: 608, y: 157, width: 158, height: 228 },
      { id: 5, x: 803, y: 157, width: 158, height: 228 },
      { id: 6, x: 998, y: 157, width: 158, height: 228 },
      { id: 7, x: 23, y: 395, width: 158, height: 228 },
      { id: 8, x: 218, y: 395, width: 158, height: 228 },
      { id: 9, x: 413, y: 395, width: 158, height: 228 },
      { id: 10, x: 608, y: 395, width: 158, height: 228 },
      { id: 11, x: 803, y: 395, width: 158, height: 228 },
      { id: 12, x: 998, y: 395, width: 158, height: 228 },
      { id: 13, x: 23, y: 633, width: 158, height: 228 },
      { id: 14, x: 218, y: 633, width: 158, height: 228 },
      { id: 15, x: 413, y: 633, width: 158, height: 228 },
      { id: 16, x: 608, y: 633, width: 158, height: 228 },
      { id: 17, x: 803, y: 633, width: 158, height: 228 },
      { id: 18, x: 998, y: 633, width: 158, height: 228 },
      { id: 19, x: 23, y: 871, width: 158, height: 228 },
      { id: 20, x: 218, y: 871, width: 158, height: 228 },
      { id: 21, x: 413, y: 871, width: 158, height: 228 },
      { id: 22, x: 608, y: 871, width: 158, height: 228 },
      { id: 23, x: 803, y: 871, width: 158, height: 228 },
      { id: 24, x: 998, y: 871, width: 158, height: 228 },
      { id: 25, x: 23, y: 1109, width: 158, height: 228 },
      { id: 26, x: 218, y: 1109, width: 158, height: 228 },
      { id: 27, x: 413, y: 1109, width: 158, height: 228 },
      { id: 28, x: 608, y: 1109, width: 158, height: 228 },
      { id: 29, x: 803, y: 1109, width: 158, height: 228 },
      { id: 30, x: 998, y: 1109, width: 158, height: 228 },
    ]);
  });
