...
describe("extractPhotoPositions for catalog images", () => {
  it("extracts 晴れ着2026", async () => {
    ...
    expect(result.value.positions).toEqual([
      ...
      { id: 2, x: 316, y: 292, width: 192, height: 274 },
      { id: 3, x: 527, y: 292, width: 192, height: 274 },
      { id: 4, x: 755, y: 292, width: 192, height: 274 },
      { id: 5, x: 981, y: 292, width: 192, height: 274 },
      { id: 6, x: 1206, y: 292, width: 192, height: 274 },
      { id: 7, x: 91, y: 596, width: 192, height: 274 },
      { id: 8, x: 316, y: 596, width: 192, height: 274 },
      { id: 9, x: 533, y: 596, width: 192, height: 274 },
      { id: 10, x: 757, y: 596, width: 192, height: 274 },
